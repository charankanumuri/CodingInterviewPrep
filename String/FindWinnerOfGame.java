...
class Solution {
    public boolean winnerOfGame(String colors) {
        ...
        //base case, if less than 3 characters, then Alice cant make move, so return false
        if(colors.length()<3)
            return false;
        
        int Alice=0, Bob=0;
        
        //We are going over entire characters and counting how many Alice and Bob can remove
